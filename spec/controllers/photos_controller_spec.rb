...
describe PhotosController do
  ...
  let(:valid_attributes) { { "photo_file" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved photo as @photo" do
        ...
        post :create, {:photo => { "photo_file" => "invalid value" }}, valid_session
        assigns(:photo).should be_a_new(Photo)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested photo" do
        ...
        Photo.any_instance.should_receive(:update_attributes).with({ "photo_file" => "MyString" })
        put :update, {:id => photo.to_param, :photo => { "photo_file" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the photo as @photo" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Photo.any_instance.stub(:save).and_return(false)
        put :update, {:id => photo.to_param, :photo => { "photo_file" => "invalid value" }}, valid_session
        assigns(:photo).should eq(photo)
      end
